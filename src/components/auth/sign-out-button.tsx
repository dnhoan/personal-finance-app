...
export function SignOutButton() {
  ...
  return (
    <button
      ...
      className="flex min-h-[64px] w-full border border-border touch-manipulation items-center gap-3 rounded-lg bg-card p-4 text-left text-danger shadow-sm transition-[transform,background-color] duration-100 [-webkit-tap-highlight-color:transparent] hover:bg-surface-muted active:scale-[0.99] active:bg-surface-muted motion-reduce:active:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-60"
    >
